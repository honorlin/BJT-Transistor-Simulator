...
Dim IIb, IIe As Double
Dim vv1, vv2 As Single
Dim VVC, VE2 As Double
...
Text8.Text = CStr(Form3.max)
Text9.Text = CStr(Form3.Hz)
End Sub
...
If (v1 + Form4.VB) > Form4.VBE Then

 IIb = (v1 + Form4.VB - Form4.VBE) / ((Form4.B + 1) * Form4.R3)
 IIe = (Form4.B + 1) * IIb
 VE2 = IIe * Form4.R3
 
    If VE2 >= 0 And (VE2 + Form4.VBE + Form4.VB + v1) <= Form4.VCC Then
