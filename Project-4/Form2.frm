...
If (v1 + form1.VB) > form1.VBE Then

 IIb = (v1 + form1.VB - form1.VBE) / ((form1.B + 1) * form1.R4)
 IIc = form1.B * IIb
 VC2 = form1.VCC - IIc * form1.R3
 
    If (v1 + form1.VB) - VC2 < form1.VBC And VC2 < form1.VCC Then
